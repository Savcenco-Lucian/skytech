                    ...
                    <div className="py-7 border-t border-gray-200">
                        <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                            ...
                            <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                                <Link href="/" className="w-9 h-9 hover:-translate-y-1 transition duration-400 rounded-full bg-transparent border border-[#F2F9FF] flex justify-center items-center hover:bg-gradient-to-r from-[#4491E1] via-[#4491E1] to-[#5D72D9] transition">
